...
import 'package:pos_dialog/src/pos_bottom_sheet/utils/bottom_sheet_suspended_curve.dart';
import 'package:pos_dialog/src/pos_bottom_sheet/utils/status_bar_gesture_detector.dart';
...
///
/// The [BasePosBottomSheet] widget itself is rarely used directly. Instead, prefer to
...
class BasePosBottomSheet extends StatefulWidget {
  /// Creates a bottom sheet.
  const BasePosBottomSheet({
    super.key,
  ...
  @override
  BasePosBottomSheetState createState() => BasePosBottomSheetState();

  /// Creates an [AnimationController] suitable for a
  /// [BasePosBottomSheet.animationController].
  ///
...
class BasePosBottomSheetState extends State<BasePosBottomSheet>
            ...
            !widget.enableDrag
                ...
                : KeyedSubtree(
                  ...
                  child: AnimatedBuilder(
                    ...
                    builder:
                        (context, _) => CustomSingleChildLayout(
                          delegate: _CustomBottomSheetLayout(
